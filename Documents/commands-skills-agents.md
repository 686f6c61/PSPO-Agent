...
| `/pspo-agent:onboarding` | [`../commands/onboarding.md`](../commands/onboarding.md) | `onboarding` | credenciales y tablero |
...
| `/pspo-agent:publish` | [`../commands/publish.md`](../commands/publish.md) | `publish` | publicación en Trello |
...
|---|---|---|---|
| `start` | [`../skills/start/SKILL.md`](../skills/start/SKILL.md) | `Read, Grep, Glob, Write, Edit, Bash, Task, AskUserQuestion` | router de entrada |
...
| `onboarding` | [`../skills/onboarding/SKILL.md`](../skills/onboarding/SKILL.md) | incluye `Bash` controlado | Trello y `.env` |
...
| `publish` | [`../skills/publish/SKILL.md`](../skills/publish/SKILL.md) | `Bash, Task, AskUserQuestion` | Trello y sincronización |
...
| `publisher` | [`../agents/publisher.md`](../agents/publisher.md) | `green` | Trello |
