...
| `/pspo-agent:onboarding` | Configuracion inicial: credenciales de Trello y tablero |
...
| `/pspo-agent:publish` | Publicar historias aprobadas en Trello |
...
PSPO Agent es un plugin no oficial de Claude Code con 6 agentes especializados (product-owner, publisher, sprint-planner, culture-guardian, requirement-analyst, senior-auditor) que cubren el ciclo completo de gestion de producto: desde el descubrimiento hasta la publicacion en Trello.
